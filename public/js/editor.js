  ...
  return function($p2){
    return new Fay$$$(function(){
      ...
      return Prelude.$36$$36$uncurried(Main.signCurrentPath(api),function($p1){
        return function($p2){
          var url = $p2;
          return Prelude.$36$$36$uncurried(Fay$$_(DOMUtils.prompt("分享"))(url),Prelude.$36$$36$uncurried(Prelude.$_const,Fay$$return$36$uncurried(Fay$$unit)));
        };
      });
    });
  };
